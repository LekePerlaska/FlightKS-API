...
namespace FlightKS.Migrations
{
    ...
    [Migration("20260614192628_RemoveFeatureFlags")]
    partial class RemoveFeatureFlags
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("FlightKS.Models.Entities.FlightSchedule", b =>
                {
                    ...
                    b.HasIndex("AircraftId", "DepartureTime")
                        .HasDatabaseName("ix_flight_schedules_aircraft_id_departure_time");
            ...
            modelBuilder.Entity("FlightKS.Models.Entities.User", b =>
                {
                    ...
                    b.HasIndex("AirlineId")
                        .HasDatabaseName("ix_users_airline_id");
            ...
            modelBuilder.Entity("FlightKS.Models.Entities.User", b =>
                {
                    b.HasOne("FlightKS.Models.Entities.Airline", "Airline")
                        ...
                        .HasForeignKey("AirlineId")
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_users_airlines_airline_id");
